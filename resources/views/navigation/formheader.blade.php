<div class="header flex items-end">  
    ...
    <div class="buttons">
      ...
      <button wire:click="save" class="text-green-600 font-bold hover:text-green-800 uppercase inline-flex items-center">@component('svg.save-disk') h-4 mr-1 @endcomponent <span class="hidden md:block">Save</span></button>
    </div>
</div>