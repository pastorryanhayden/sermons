...
<a href="/embeds" class="flex p-3 items-center hover:bg-gray-200"><span class="uppercase tracking-wide hidden group-hover:block mr-2 w-32 p-3">{{ __('Embed') }}</span><span class="rounded  text-gray-500 p-2">@component('svg.code') h-5 @endcomponent</span></a>
@endslot
