<li class="bg-white w-full lg:h-20 flex-wrap p-4 flex mb-2 shadow rounded items-center tracking-normal">
	<section class="main flex mb-4 lg:mb-0 lg:mr-6 w-full lg:w-auto flex-grow items-center">
		...
		<div class="title flex flex-col justify-center lg:w-64">
			<a href="/sermons/{{$sermon->id}}/edit" class="mb-1"><h3 class=" ">{{$sermon->title}}</h3></a>
	...
	<section class="date flex items-center mb-4 lg:mb-0 sm:mr-2 lg:mr-6 w-full sm:w-32">
	...
	<section class="speaker flex items-center  mb-4 lg:mb-0 sm:mr-2 lg:mr-6 w-full sm:w-32">
	...
	<section class="actions flex items-center lg:justify-center w-full lg:w-24">
